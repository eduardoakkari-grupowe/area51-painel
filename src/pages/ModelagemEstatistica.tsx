    ...
    <div id="renda" className="mt-10 scroll-mt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card border border-border rounded-xl p-6 overflow-auto">
          ...
          <Table>
            ...
            <TableBody>
              {[
                { f: "R$1.562 a R$10.000", cl: "10.359", g: "R$ 247,59", fr: "1,51", rm: "R$ 6.134" },
      ...
      <div className="mt-6 bg-card border border-border rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-x-6 lg:gap-y-4">
            {/* Row 1 */}
            <div className="p-4 bg-accent/10 border border-accent/30 rounded-lg flex flex-col justify-between">
              <div>
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <div className="space-y-5">
            {[
              { nome: "Jovem Econômico", qtd: "1.015", pct: "5,5%", idade: "média: 36 (80% concentrados entre 24 e 49 anos)", renda: "R$4.983", gasto: "R$240", freq: "1,44", perfil: "Alta posse de moto (84%), digital (64%). Sem luxo nem imóvel alto padrão.", campanha: "Entrada com preço acessível, comunicação jovem e prática.", foto: personaM1 },
